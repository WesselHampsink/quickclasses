...
/** QuickSorting Class */
"use strict";class QuickSorting{constructor({elementsSelector:e="[data-index]",sortSelectSelector:t='select[name="sort"]',parentElement:s=null,callBackFunction:l=null}){this.elements=document.querySelectorAll(e),null!==this.elements&&(this.sortSelect=document.querySelector(t),null!==this.sortSelect&&(this.parentElement=document.querySelector(s),null!==this.parentElement&&(this.callBackFunction=l,this.appendEvent(),this.selectedValue={key:this.sortSelect.options[this.sortSelect.selectedIndex].dataset.key,order:this.sortSelect.options[this.sortSelect.selectedIndex].dataset.order,type:this.sortSelect.options[this.sortSelect.selectedIndex].dataset.type})))}init(){this.getSelectedValue(),this.parentElement.innerHTML="",this.sort().forEach(e=>{this.parentElement.appendChild(e)}),null!==this.callBackFunction&&this.callBackFunction()}appendEvent(){this.sortSelect.addEventListener("change",()=>{this.init()})}getSelectedValue(){return this.selectedValue={key:this.sortSelect.options[this.sortSelect.selectedIndex].dataset.key,order:this.sortSelect.options[this.sortSelect.selectedIndex].dataset.order,type:this.sortSelect.options[this.sortSelect.selectedIndex].dataset.type}}sort(){let e=this.selectedValue.key,t=this.selectedValue.order,s=this.selectedValue.type;return[...this.elements].sort((l,a)=>"random"===e?.5-Math.random():"CHAR"===s?"ASC"===t?l.dataset[e].localeCompare(a.dataset[e]):a.dataset[e].localeCompare(l.dataset[e]):"NUM"===s?"ASC"===t?parseFloat(l.dataset[e])-parseFloat(a.dataset[e]):parseFloat(a.dataset[e])-parseFloat(l.dataset[e]):void 0)}}
